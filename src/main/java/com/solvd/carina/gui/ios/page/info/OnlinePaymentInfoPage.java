...
@DeviceType(pageType = DeviceType.Type.IOS_PHONE, parentClass = OnlinePaymentInfoBasePage.class)
public class OnlinePaymentInfoPage extends OnlinePaymentInfoBasePage {
    ...
    @ExtendedFindBy(iosClassChain = "**/XCUIElementTypeStaticText[`label == \"ОПЛАТА ОНЛАЙН\"`]")
