...
@DeviceType(pageType = DeviceType.Type.IOS_PHONE, parentClass = VacanciesInfoBasePage.class)
public class VacanciesInfoPage extends VacanciesInfoBasePage {
    ...
    @ExtendedFindBy (iosClassChain = "**/XCUIElementTypeStaticText[`label == \"ООО БТМ ТРЕЙДИНГ\"`]")
