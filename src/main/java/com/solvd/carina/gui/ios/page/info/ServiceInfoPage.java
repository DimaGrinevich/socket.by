...
@DeviceType(pageType = DeviceType.Type.IOS_PHONE, parentClass = ServiceInfoBasePage.class)
public class ServiceInfoPage extends ServiceInfoBasePage {
    ...
    @ExtendedFindBy (iosClassChain = "**/XCUIElementTypeStaticText[`label == \"СЕРВИС\"`]")
